...
return [
    ...
    /*
     * The spec (`/api/v1/openapi.json`) and docs UI (`/docs/api`) are meant to be
     * publicly readable — clients need the spec before they have an API key.
     * Scramble's default `RestrictedDocsAccess` middleware limits both to the
     * local environment, so it's intentionally omitted here.
     */
    'middleware' => [
        'web',
    ],
