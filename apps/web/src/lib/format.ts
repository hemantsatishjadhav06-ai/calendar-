...
export const NETWORK_LABEL: Record<string, string> = { FACEBOOK: 'Facebook', INSTAGRAM: 'Instagram', THREADS: 'Threads', X: 'X', LINKEDIN: 'LinkedIn', TIKTOK: 'TikTok', YOUTUBE: 'YouTube', PINTEREST: 'Pinterest', GOOGLE_BUSINESS: 'Google Business', BLUESKY: 'Bluesky', MASTODON: 'Mastodon', DEVTO: 'DEV.to', DISCORD: 'Discord', START_PAGE: 'Start Page' };
export const NETWORK_SHORT: Record<string, string> = { FACEBOOK: 'f', INSTAGRAM: 'ig', THREADS: '@', X: 'X', LINKEDIN: 'in', TIKTOK: 'tt', YOUTUBE: '▶', PINTEREST: 'P', GOOGLE_BUSINESS: 'G', BLUESKY: 'bs', MASTODON: 'm', DEVTO: 'DEV', DISCORD: 'D', START_PAGE: 'S' };
